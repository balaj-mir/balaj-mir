<h1 align="center">Hi, I'm Balaj Mir 👋</h1>
<h3 align="center">Software Engineering Graduate · Full-Stack Developer · AI/ML Integration</h3>

<p align="center">
  BS Software Engineering @ CUST, Islamabad (2022–2026) &nbsp;•&nbsp; Rawalpindi, Pakistan
</p>
...
I'm a Software Engineering graduate from CUST who prefers building working products over class assignments that just check a box. Shirtify, my final year project, is a full virtual try-on e-commerce platform, and outside of coursework I've put together several other systems on my own time, including multi-agent AI pipelines and backends built the way production systems actually get built. I spent August and September 2025 as an ML & AI intern at EziTech, which is where a lot of my applied ML habits come from. I'm comfortable owning a problem from the UI down to the model, across React/Next.js, Node/FastAPI, and whatever ML the problem actually needs.

A few other things worth knowing: I placed in the top 4% of over 2,600 participants nationally in APPEC, the All Pakistan Prompt Engineering Competition. I built BidEngine, an AI bid and proposal engine, during CUST Hackathon 2026, and picked up a Team Management certification from the 2025 hackathon before that. I use tools like Claude, Copilot, and Cursor as part of my actual workflow, not as a novelty. Right now I'm spending most of my spare time on RAG and multi-agent systems with CrewAI.
